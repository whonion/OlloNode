...
echo '=============== KURULUM TAMAMLANDI :D ==================='
echo -e 'Logları kontrol etmek için: \e[1m\e[32mjournalctl -u ollod -f -o cat\e[0m'
echo -e "SYNC Kontrol Etmek için: \e[1m\e[32mcurl -s localhost:${OLLO_PORT}657/status | jq .result.sync_info\e[0m"
